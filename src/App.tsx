...
const Providers = ({ children }: { children: ReactNode }) => <Helmet.HelmetProvider>{children}</Helmet.HelmetProvider>
...
const Head = () => (
  <Helmet.Helmet>
    ...
    <body className="font-copy dark:bg-slate-800 dark:text-slate-200" />
  </Helmet.Helmet>
)
...
const MaikCard = () => (
  <Card className="mx-auto flex w-full flex-col md:w-3/4 xl:grid xl:w-auto xl:max-w-screen-lg xl:grid-cols-2">
    <div className="relative">
      ...
      <div className="absolute bottom-0 h-1/8 w-full dark:bg-gradient-b-slate-800 xl:top-0 xl:right-0 xl:h-full xl:w-1/8 dark:xl:bg-gradient-r-slate-800"></div>
    </div>
...
const ProjectCardsListSectionContents = ({
  ...
  <div className="isolate flex flex-col gap-8">
    <div className={classNames('sticky top-0 z-10 flex flex-row justify-center py-5', sectionBgColorClassName)}>
  ...
  return (
    <Card
      ...
      className="relative flex flex-col
        ...
        before:opacity-[var(--opacity)] before:transition-opacity
          ...
          <picture>
            {project.images && (
              <>
                <source
                  type="image/avif"
                  srcSet={project.images.avif.lg.default + ' 800w'}
                  media={image800MediaSelector}
                />
                <source
                  type="image/avif"
                  srcSet={project.images.avif.md.default + ' 400w'}
                  media={image400MediaSelector}
                />
                <source
                  type="image/webp"
                  srcSet={project.images.webp.lg.default + ' 800w'}
                  media={image800MediaSelector}
                />
                <source
                  type="image/webp"
                  srcSet={project.images.webp.md.default + ' 400w'}
                  media={image400MediaSelector}
                />
                <source
                  type="image/png"
                  srcSet={project.images.png.lg.default + ' 800w'}
                  media={image800MediaSelector}
                />
                <source
                  type="image/png"
                  srcSet={project.images.png.md.default + ' 400w'}
                  media={image400MediaSelector}
                />
            ...
            {!project.images && <img src={EmptyImage.default} className="w-full rounded-t-xl" alt="" />}
          </picture>
        </figure>

        {project.images && <div className="absolute bottom-0 h-1/8 w-full dark:bg-gradient-b-slate-800"></div>}
      </div>
  ...
  return (
    <div className="flex flex-col gap-3">
      <h1 className="flex flex-row items-center gap-3">
        <TitleIcon className="inline-block h-8 w-8 fill-slate-300" />
